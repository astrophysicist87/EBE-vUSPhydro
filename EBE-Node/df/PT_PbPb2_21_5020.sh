...
#SBATCH --output=logs/21_44.out
#SBATCH --error=logs/21_44.err
...
srun /projects/jn511_1/v-USPhydro/df/v1/fo trentoinputPbPb2_21_"$i".dat 0 999 omega.dat 0.2 3 1 trentoPbPb25020mul 0 > logs/PbPb2_21_"$i".dat

...
//	}
	...
	for (int c=0;c<sep;c++) {
		...
		string name2="out/"+sfol+"/"+bname+"avg_"+convertInt(cnam)+vnin+".dat";
		
		if (decays==0) name2="out/"+sfol+"/"+bname+"avg_"+convertInt(cnam)+vnin+"ND.dat";
		if (decays==3) name2="out/"+sfol+"/"+bname+"avg_"+convertInt(cnam)+vnin+"nodf.dat";
		if (decays==2) name2="out/"+sfol+"/"+bname+"avg_"+convertInt(cnam)+vnin+"negND.dat";
		
		string namrn="out/"+sfol+"/"+bname+"rn_"+convertInt(cnam)+vnin+".dat";
		
		if (decays==0) namrn="out/"+sfol+"/"+bname+"rn_"+convertInt(cnam)+vnin+"ND.dat";
		if (decays==3) namrn="out/"+sfol+"/"+bname+"rn_"+convertInt(cnam)+vnin+"nodf.dat";
		if (decays==2) namrn="out/"+sfol+"/"+bname+"rn_"+convertInt(cnam)+vnin+"negND.dat";
		
		string namsc="out/"+sfol+"/"+bname+"scm_"+convertInt(cnam)+vnin+".dat";
		
		if (decays==0) namsc="out/"+sfol+"/"+bname+"scm_"+convertInt(cnam)+vnin+"ND.dat";
		if (decays==3) namsc="out/"+sfol+"/"+bname+"scm_"+convertInt(cnam)+vnin+"nodf.dat";
		if (decays==2) namsc="out/"+sfol+"/"+bname+"scm_"+convertInt(cnam)+vnin+"negND.dat";
		
		string namcum="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+".dat";
		
		if (decays==0) namcum="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"ND.dat";
		if (decays==3) namcum="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"nodf.dat";
		if (decays==2) namcum="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"negND.dat";
		
		string namrms="out/"+sfol+"/"+bname+"rms_"+convertInt(cnam)+vnin+".dat";

                if (decays==0) namrms="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"ND.dat";
                if (decays==3) namrms="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"nodf.dat";
                if (decays==2) namrms="out/"+sfol+"/"+bname+"cum_"+convertInt(cnam)+vnin+"negND.dat";
...
//				}
	...
	//	cout << a.c2[1][3] << " " << a.c4[1][3] << " " <<  pow(a.c4[1][3],0.25)/a.c2[1][3] << endl;
...
void cum(outs & a, string name2, double p[], int psize){
	...
	for (int i=0;i<psize;i++) // runs over all pts 
	{
		...
		OUT << p[i] <<  "  " ;
		for (int v=0;v<6;v++) OUT << pow(a.c4[v][i],0.25)/sqrt(a.c2[v][i])  << " ";
		OUT << endl;

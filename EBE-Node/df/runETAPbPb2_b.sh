...
#SBATCH --job-name=PbPbeta            # Assign an short name to your job
#SBATCH --array=0-999
...
#SBATCH --output=logs/PbPb2eta.out
#SBATCH --error=logs/PbPb2eta.err
...
let j="$SLURM_ARRAY_TASK_ID"+1000

if [ $j -le 499 ]
then
    srun /home/projects/jn511_1/v-USPhydro/df/fo trentoinputPbPb2eta_21_e0.04.dat  PbPb2_21_e0.04  "$j"  neg 0 0  > runs/PbPb2_0.04_"$j".dat

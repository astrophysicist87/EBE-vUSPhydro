...
class DeformedWoodsSaxonNucleus : public MinDistNucleus {
 public:
  ...
  /// \param dmin minimum nucleon-nucleon distance (optional, default zero)
  DeformedWoodsSaxonNucleus(std::size_t A, double R, double a, double omega,
 ...
 private:
  ...
  /// Evaluate the deformed Woods-Saxon distribution with 3Fermi fit parameters.
  double deformed_woods_saxon_dist3F(double r, double cos_theta) const;

  /// Woods-Saxon parameters.
  const double R_, a_, om_, beta2_,  beta3_, beta4_;

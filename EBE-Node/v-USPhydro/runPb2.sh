...
let i="$SLURM_ARRAY_TASK_ID"
 echo logs/TYP_BINN > runs/PbPb2_TYP_BINN_"$i".dat
srun /home/projects/jn511_1/v-USPhydro/charm.sh PbPb2_TYP_BINN "$i" "$i" shear EOSTYPE/BINN trento PbPb5020TeV >> runs/PbPb2_TYP_BINN_"$i".dat

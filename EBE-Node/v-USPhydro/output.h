...
void Output<D>::sveprofile(LinkList<D> &linklist)
{
	...
	{
		EPN << linklist.t << " " << linklist.S <<  endl;
...
{ 	
  	...
  	{
	FO <<  linklist.divTtemp[i] << " " << linklist.divT[i] << " " << linklist.gsub[i] << " " << linklist.uout[i] << " " << linklist.swsub[i] << " " <<   linklist.tlist[i] <<  " " << linklist.rsub[i] << " " << linklist.sFO[i] <<  endl;
	}
  	FO.close();
...
{ 	
  	...
  	for (int i=0;i< linklist.cf;i++)
  	{
  	FO <<  linklist.divTtemp[i] << " " << linklist.divT[i] << " " << linklist.gsub[i] << " " << linklist.uout[i] << " " << linklist.swsub[i] <<   " " << linklist.bulksub[i]  << " " <<   linklist.tlist[i] <<  " " << linklist.rsub[i] <<  " " << linklist.sFO[i] << endl;
	}
  	FO.close();

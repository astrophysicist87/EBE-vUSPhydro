...
if [ $i -le 499 ]
then
 echo logs/PbPb2_0 > runs/PbPb2_0_"$i".dat
srun /home/projects/jn511_1/v-USPhydro/icharm.sh PbPb2eta_21_e0 "$i" "$i" shear  EOS21/e0  trento PbPb5020TeV >> runs/PbPb2_0_"$i".dat
else
let j="$i"-500
echo logs/XeXe_0 > runs/XeXe_0_"$j".dat
srun /home/projects/jn511_1/v-USPhydro/icharm.sh XeXeeta_21_e0 "$j" "$j" shear  EOS21/e0  trento XeXe5440TeVdef >> runs/XeXe_0_"$j".dat
fi

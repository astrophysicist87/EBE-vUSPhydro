...
#SBATCH --job-name=HeAu_EOS21bulk_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jnorhos/v-USPhydro2/charm.sh HeAu_EOS21bulk_BINN "$i" "$i" shear EOS21bulk/BINN trento HeAu200GeV > runs/FILENAME_"$i".dat

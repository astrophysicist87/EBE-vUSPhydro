...
#SBATCH --job-name=UUmus_c52_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUmus_c52_BINN "$i" "$i" shear c52/BINN trento UUmus200GeV > runs/UUmus_c52_BINN_"$i".dat

...
#SBATCH --job-name=UUmus_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUmus_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUmus200GeV > runs/UUmus_EOS21_BINN_"$i".dat

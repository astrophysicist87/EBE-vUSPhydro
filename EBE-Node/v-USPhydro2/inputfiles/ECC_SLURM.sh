...
srun /projects/jn511_1/v-USPhydro2/inputfiles/npart trento/DIRECTORY/"$i" 0 999  > logs/FILENAME"$i".dat
srun /projects/jn511_1/v-USPhydro2/inputfiles/eccCM trento/DIRECTORY/"$i" 0 999 GRID cgc >> logs/FILENAME"$i".dat

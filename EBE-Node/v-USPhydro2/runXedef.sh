...
let i="$SLURM_ARRAY_TASK_ID"
 echo logs/TYP_BINN > runs/XeXeTYP_BINN_"$i".dat
srun /projects/jn511_1/v-USPhydro2/charm.sh XeXedef_TYP_BINN "$i" "$i" shear EOSTYP/BINN trento FOL >> runs/XeXeTYP_BINN_"$i".dat

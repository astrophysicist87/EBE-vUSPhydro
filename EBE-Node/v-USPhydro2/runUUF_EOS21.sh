...
#SBATCH --job-name=UUF_EOS21_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUF_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUF200GeV > runs/UUF_EOS21_BINN_"$i".dat

...
#SBATCH --job-name=UUE_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUE_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUE200GeV > runs/UUE_EOS21_BINN_"$i".dat

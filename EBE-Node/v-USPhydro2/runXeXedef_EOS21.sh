...
#SBATCH --job-name=XeXedef_EOS21_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh XeXedef_EOS21_BINN "$i" "$i" shear EOS21/BINN trento XeXe5440TeVdef_b236 > runs/XeXedef_EOS21_BINN_"$i".dat

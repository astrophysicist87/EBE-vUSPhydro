...
#SBATCH --job-name=UUD_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUD_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUD200GeV > runs/UUD_EOS21_BINN_"$i".dat

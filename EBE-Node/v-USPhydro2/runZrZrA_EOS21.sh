...
#SBATCH --job-name=ZrA_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh ZrZrA_EOS21_BINN "$i" "$i" shear EOS21/BINN trento ZrZrA200GeV > runs/ZrZrA_EOS21_BINN_"$i".dat

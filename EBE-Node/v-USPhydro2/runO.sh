...
#SBATCH --output=logs/OO_TYP_BINN.out
#SBATCH --error=logs/OO_TYP_BINN.err
...
let i="$SLURM_ARRAY_TASK_ID"
 echo logs/TYP_BINN > runs/OO_TYP_BINN_"$i".dat
srun /projects/jn511_1/v-USPhydro2/charm.sh OO_TYP_BINN "$i" "$i" shear EOS21/BINN trento OO_TYP_65TeV >> runs/OO_TYP_BINN_"$i".dat

...
#SBATCH --job-name=EOS21_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh XeXehalfdef_EOS21_BINN "$i" "$i" shear EOS21/BINN trento XeXehalf5440TeVdef_b2 > runs/XeXehalfdef_EOS21_BINN_"$i".dat

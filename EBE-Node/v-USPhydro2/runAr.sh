...
#SBATCH --output=logs/ArAr_TYP_BINN.out
#SBATCH --error=logs/ArAr_TYP_BINN.err
...
let i="$SLURM_ARRAY_TASK_ID"
 echo logs/TYP_BINN > runs/ArAr_TYP_BINN_"$i".dat
srun /projects/jn511_1/v-USPhydro2/charm.sh ArAr_TYP_BINN "$i" "$i" shear EOS21/BINN trento ArAr_TYP_585TeV >> runs/ArAr_TYP_BINN_"$i".dat

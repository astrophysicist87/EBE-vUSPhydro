...
#SBATCH --job-name=RuB_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh RuRuB_EOS21_BINN "$i" "$i" shear EOS21/BINN trento RuRuB200GeV > runs/RuRuB_EOS21_BINN_"$i".dat

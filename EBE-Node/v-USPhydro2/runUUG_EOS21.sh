...
#SBATCH --job-name=UUG_EOS21_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUG_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUG200GeV > runs/UUG_EOS21_BINN_"$i".dat

...
#SBATCH --job-name=OOconf_EOS21_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh OOconf_EOS21_BINN "$i" "$i" shear EOS21/BINN trento OOconf6500TeV > runs/OOconf_EOS21_BINN_"$i".dat

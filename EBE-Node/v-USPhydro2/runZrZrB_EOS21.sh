...
#SBATCH --job-name=ZrB_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh ZrZrB_EOS21_BINN "$i" "$i" shear EOS21/BINN trento ZrZrB200GeV > runs/ZrZrB_EOS21_BINN_"$i".dat

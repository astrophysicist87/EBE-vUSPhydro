...
#SBATCH --job-name=UUH_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUH_EOS21_BINN "$i" "$i" shear EOS21/BINN trento UUH200GeV > runs/UUH_EOS21_BINN_"$i".dat

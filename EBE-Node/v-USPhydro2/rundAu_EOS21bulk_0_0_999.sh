...
#SBATCH --job-name=dAu_EOS21bulk_0_0            # Assign an short name to your job
#SBATCH --array=0-999
...
srun /projects/jnorhos/v-USPhydro2/charm.sh dAu_EOS21bulk_0 "$i" "$i" shear EOS21bulk/0 trento dAu200GeV > runs/FILENAME_"$i".dat

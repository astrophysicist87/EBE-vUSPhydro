...
#SBATCH --job-name=RuC_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh RuRuC_EOS21_BINN "$i" "$i" shear EOS21/BINN trento RuRuC200GeV > runs/RuRuC_EOS21_BINN_"$i".dat

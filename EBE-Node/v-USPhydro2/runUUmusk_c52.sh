...
#SBATCH --job-name=UUmusk_c52_BINN_BINN            # Assign an short name to your job
#SBATCH --array=EVENTS
...
srun /projects/jn511_1/v-USPhydro2/charm.sh UUmusk_c52_BINN "$i" "$i" shear c52/BINN trento UUmusk200GeV > runs/UUmusk_c52_BINN_"$i".dat

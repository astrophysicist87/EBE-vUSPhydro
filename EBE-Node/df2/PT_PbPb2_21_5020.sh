...
#SBATCH --output=logs/21_60.out
#SBATCH --error=logs/21_60.err
...
srun /projects/jn511_1/v-USPhydro2/df/v1/fo trentoinputPbPb2_21_"$i".dat 0 999 lambda.dat 0.2 3 1 trento5020mul 0 > logs/PbPb2_21_"$i".dat

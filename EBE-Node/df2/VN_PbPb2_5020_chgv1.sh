...
#SBATCH --output=logs/5020_61.out
#SBATCH --error=logs/5020_61.err
...
srun /projects/jn511_1/v-USPhydro2/df/v1/fo trentoinputPbPb2_5020_"$i".dat 0 999 21.dat 0.2 3 1 trentoPbPb2chgv1mul 1 > logs/PbPb2_5020_"$i".dat

...
#SBATCH --output=logs/3pF_30.out
#SBATCH --error=logs/3pF_30.err
...
srun /projects/jn511_1/v-USPhydro2/df/v1/fo trentoinputArAr_3pF_"$i".dat 0 999 cascade.dat 0.2 3 1 trentoArAr585mul 0 > logs/ArAr_3pF_"$i".dat

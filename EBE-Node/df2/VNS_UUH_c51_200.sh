...
#SBATCH --output=logs/c51_1.out
#SBATCH --error=logs/c51_1.err
...
srun /projects/jn511_1/v-USPhydro2/df/vns/fo trentoinputUUH_c51_"$i".dat 0 999 chgv1.dat 0.2 3 1 trentoUUH200mul 0 > logs/UUH_c51_"$i".dat

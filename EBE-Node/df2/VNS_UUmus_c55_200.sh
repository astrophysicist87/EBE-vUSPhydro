...
#SBATCH --output=logs/c55_1.out
#SBATCH --error=logs/c55_1.err
...
srun /projects/jn511_1/v-USPhydro2/df/vns/fo trentoinputUUmus_c55_"$i".dat 0 999 chgv1.dat 0.2 3 1 trentoUUmus200mul 0 > logs/UUmus_c55_"$i".dat

...
#SBATCH --output=logs/b2_10.out
#SBATCH --error=logs/b2_10.err
...
srun /projects/jn511_1/v-USPhydro2/df/v1/fo trentoinputXeXedef_b2_"$i".dat 0 999 chgv1.dat 0.2 3 1 trentoXeXedef5440b2mul 1 > logs/XeXedef_b2_"$i".dat

...
#SBATCH --output=logs/21_9.out
#SBATCH --error=logs/21_9.err
...
srun /projects/jn511_1/v-USPhydro2/df/vns/fo trentoinputAuAu_21_"$i".dat 0 999 chgv1.dat 0.2 3 1 trento200mul 0 > logs/AuAu_21_"$i".dat

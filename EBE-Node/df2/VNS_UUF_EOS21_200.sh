...
#SBATCH --output=logs/EOS21_1.out
#SBATCH --error=logs/EOS21_1.err
...
srun /projects/jn511_1/v-USPhydro2/df/vns/fo trentoinputUUF_EOS21_"$i".dat 0 999 chgv1.dat 0.2 3 1 trentoUUF200mul 0 > logs/UUF_EOS21_"$i".dat

...
#SBATCH --output=logs/21_35.out
#SBATCH --error=logs/21_35.err
...
srun /projects/jn511_1/v-USPhydro2/df/v1/fo trentoinputXeXedef_21_"$i".dat 0 999 lambda.dat 0.2 3 1 trentoXeXedef5440mul 1 > logs/XeXedef_21_"$i".dat

...
#SBATCH --output=logs/EOS21_30.out
#SBATCH --error=logs/EOS21_30.err
...
srun /projects/jn511_1/v-USPhydro2/df/vns/fo trentoinputOO_EOS21_"$i".dat 0 999 chgv1.dat 0.2 3 1 trentoOO6500mul 0 > logs/OO_EOS21_"$i".dat

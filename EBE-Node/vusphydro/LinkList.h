...
public:
	...
	void bsqoptimization2(int a,double tin,int & count);
	void bsqoptimization(int a);
...
void LinkList<D>::bsqoptimization(int a)
{
...
template <int D>
void LinkList<D>::bsqoptimization2(int a,double tin,int & count)
{

...
#SBATCH --output=logs/21_%A_%a.out
#SBATCH --error=logs/21_%A_%a.err
...
srun /projects/jn511_1/v-USPhydro/df/v1/fo trentoinputXeXe_21_"$i".dat 0 999 K+.dat 0.2 3 1 trentoXeXe5440mul 1 > logs/vnint"$i".dat

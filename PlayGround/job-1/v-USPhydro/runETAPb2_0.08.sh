...
#SBATCH --output=logs/Pb2eta_0.08.out
#SBATCH --error=logs/Pb2eta_0.08.err
...
srun /home/projects/jn511_1/v-USPhydro/ncharm.sh PbPb2eta_21_e0.08 "$i" "$i" shear  EOS21/e0.08  trento PbPb5020TeV > runs/PbPb2_0.08_"$i".dat

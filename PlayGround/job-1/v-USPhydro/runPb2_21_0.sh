...
#SBATCH --output=logs/PbPb2_21_0.out
#SBATCH --error=logs/PbPb2_21_0.err
...
srun /home/projects/jn511_1/v-USPhydro/charm.sh PbPb2_21_0 "$i" "$i" shear EOS21/0 trento PbPb5020TeV >> runs/PbPb2_21_0_"$i".dat
